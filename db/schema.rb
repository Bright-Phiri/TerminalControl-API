...
ActiveRecord::Schema[8.0].define(version: 2025_12_23_070614) do
  ...
  create_table "taxpayers", force: :cascade do |t|
    ...
    t.string "role"
    t.index ["tin"], name: "index_taxpayers_on_tin", unique: true
  end
  ...
  create_table "terminals", force: :cascade do |t|
    ...
    t.index ["terminal_id"], name: "index_terminals_on_terminal_id", unique: true
  end
